...
WaitPl1  DB 'Press down to connect with Player1...$'
...
UserName2 PROC
     ...
     ;GETTIG STRING INPUT FROM KEYBOARD
     
     MOV AH,0AH
     LEA DX,PL2NAME
     INT 21H
     
     ;ENFORCING THE PROGRAM TO TAKE THE FIRST 8 CHARACTERS FROM THE NAME
     ;NO WHERE FOR MORE 
...
SendDown:   
     ...
     IN AL,DX
     AND AL,00100000B
     JZ SendDown ;wait till l holding reg. yfda                        
        
     ;send what is in sentData to transmit data reg.
     MOV DX,3F8H  
     MOV AL,50H ;send down scan code
     OUT DX,AL 
                        
            RET
WaitPl1Connect  ENDP
;====================================================================
RecieveUserName1  PROC
    ;recieve Act1Size (size of username1)
...
RecSize1:
        ...
        IN AL,DX
        AND AL,1
        JZ RecSize1 ;wait till I recieve size                        
        
        ;recieve l size fe AL
        MOV DX,3F8H
        IN AL,DX
        ;7ut l size fe ACT1SIZE
        MOV ACT1SIZE, AL
...
RecUser1Loop:   
        ...
        ;recieve awl 7rf w 7utu fe PL1Name
        MOV DX,3F8H
        IN AL,DX
        MOV [BX], AL
        ;incerements
        ...
        JNZ RecUser1Loop
            ...
            RET
RecieveUserName1  ENDP
;====================================================================
SendUserName2  PROC
            
    ;send Act2Size (size of username2
    MOV DX,3FDH  
...
sendSize2:
        ...
        IN AL,DX
        AND AL,00100000B
        JZ sendSize2 ;wait till l holding reg. yfda                        
...
sendUser2Loop:   
        ...
        IN AL,DX
        AND AL,00100000B
        JZ sendUser2Loop ;wait till l holding reg. yfda                        
        
        ;send 7rf 7rf mn PL2Name
        MOV DX,3F8H  
        MOV AL,[BX]
        OUT DX,AL 
        ;incerements
